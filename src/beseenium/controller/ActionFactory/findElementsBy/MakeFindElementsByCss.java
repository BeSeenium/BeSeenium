...
import beseenium.model.action.findElementsBy.FindElementsByCss;

/**
 * Creates a new FindElementsByCss action
 * @author Jan P.C. Hanson
 *
 */
public class MakeFindElementsByCss extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeFindElementsByCss(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new FindElementsByCss(super.adFactory.makeActionData());
	}
}
