...
import beseenium.model.action.findElementsBy.FindElementsByPartialLinkTxt;
 ...
 *
 */
public class MakeFindElementsByPartialLinkTxt extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeFindElementsByPartialLinkTxt(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new FindElementsByPartialLinkTxt(super.adFactory.makeActionData());
	}
}
