...
import beseenium.model.action.findElementsBy.FindElementsById;
 ...
 *
 */
public class MakeFindElementsById extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeFindElementsById(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new FindElementsById(super.adFactory.makeActionData());
	}
}
