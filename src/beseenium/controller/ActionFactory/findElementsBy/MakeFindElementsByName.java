...
import beseenium.model.action.findElementsBy.FindElementsByName;

/**
 * creates a new FindElementsByName action
 * @author Jan P.C. Hanson
 *
 */
public class MakeFindElementsByName extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeFindElementsByName(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new FindElementsByName(super.adFactory.makeActionData());
	}
}
