...
import beseenium.model.action.findElementsBy.FindElementsByXpath;

/**
 * creates a new FindElementsByXpath action
 * @author Jan P.C. Hanson
 *
 */
public class MakeFindElementsByXpath extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeFindElementsByXpath(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new FindElementsByXpath(super.adFactory.makeActionData());
	}
}
