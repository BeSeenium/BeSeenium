...
import beseenium.model.action.findElementsBy.FindElementsByClass;
 ...
 *
 */
public class MakeFindElementsByClass extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeFindElementsByClass(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new FindElementsByClass(super.adFactory.makeActionData());
	}
}
