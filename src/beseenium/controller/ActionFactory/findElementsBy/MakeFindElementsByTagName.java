...
import beseenium.model.action.findElementsBy.FindElementsByTagName;
 ...
 *
 */
public class MakeFindElementsByTagName extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeFindElementsByTagName(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new FindElementsByTagName(super.adFactory.makeActionData());
	}
}
