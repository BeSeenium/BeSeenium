...
import beseenium.model.action.navigateActions.RefreshPage;

/**
 * creates a new RefreshPage action
 * @author Jan P.C. Hanson
 *
 */
public class MakeRefreshPage extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeRefreshPage(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new RefreshPage(super.adFactory.makeActionData());
	}
}
