...
import beseenium.model.action.navigateActions.NavigateForward;
 ...
 *
 */
public class MakeNavigateForward extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeNavigateForward(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new NavigateForward(super.adFactory.makeActionData());
	}
}
