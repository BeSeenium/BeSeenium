...
import beseenium.model.action.elementActions.GetTagName;

/**
 * creates a new GetTagName action
 * @author Jan P.C. Hanson
 *
 */
public class MakeGetTagName extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeGetTagName(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new GetTagName(super.adFactory.makeActionData());
	}
}
