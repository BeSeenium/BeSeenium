...
import beseenium.model.action.elementActions.IsSelected;

/**
 * creates a new IsSelected action
 * @author Jan P.C. Hanson
 *
 */
public class MakeIsSelected extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeIsSelected(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new IsSelected(super.adFactory.makeActionData());
	}
}
