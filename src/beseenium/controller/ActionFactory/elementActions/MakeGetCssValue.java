...
import beseenium.model.action.elementActions.GetCssValue;

/**
 * creates a new GetCssValue action
 * @author Jan P.C. Hanson
 *
 */
public class MakeGetCssValue extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeGetCssValue(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new GetCssValue(super.adFactory.makeActionData());
	}
}
