...
import beseenium.model.action.elementActions.Clear;
 ...
 *
 */
public class MakeClear extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeClear(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new Clear(super.adFactory.makeActionData());
	}
}
