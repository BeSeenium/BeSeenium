...
import beseenium.model.action.elementActions.SendKeys;

/**
 * creates a new SendKeys action
 * @author Jan P.C. Hanson
 *
 */
public class MakeSendKeys extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeSendKeys(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new SendKeys(super.adFactory.makeActionData());
	}
}
