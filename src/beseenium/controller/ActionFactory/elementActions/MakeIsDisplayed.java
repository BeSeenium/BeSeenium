...
import beseenium.model.action.elementActions.IsDisplayed;

/**
 * creates a new IsDisplayed action
 * @author Jan P.C. Hanson
 *
 */
public class MakeIsDisplayed extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeIsDisplayed(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new IsDisplayed(super.adFactory.makeActionData());
	}
}
