...
import beseenium.model.action.elementActions.IsEnabled;

/**
 * creates a new IsEnabled action
 * @author Jan P.C. Hanson
 *
 */
public class MakeIsEnabled extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeIsEnabled(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new IsEnabled(super.adFactory.makeActionData());
	}
}
