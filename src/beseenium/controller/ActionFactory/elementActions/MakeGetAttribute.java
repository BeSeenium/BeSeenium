...
import beseenium.model.action.elementActions.GetAttribute;
 ...
 *
 */
public class MakeGetAttribute extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeGetAttribute(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new GetAttribute(super.adFactory.makeActionData());
	}
}
