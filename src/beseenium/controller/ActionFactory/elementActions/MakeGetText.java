...
import beseenium.model.action.elementActions.GetText;

/**
 * creates a new GetText action
 * @author Jan P.C. Hanson
 *
 */
public class MakeGetText extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeGetText(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new GetText(super.adFactory.makeActionData());
	}
}
