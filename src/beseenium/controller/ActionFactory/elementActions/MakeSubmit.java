...
import beseenium.model.action.elementActions.Submit;
 ...
 *
 */
public class MakeSubmit extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeSubmit(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new Submit(super.adFactory.makeActionData());
	}
}
