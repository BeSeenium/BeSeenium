...
import beseenium.model.action.elementActions.GetSize;

/**
 * creates a new GetSize action
 * @author Jan P.C. Hanson
 *
 */
public class MakeGetSize extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeGetSize(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new GetSize(super.adFactory.makeActionData());
	}
}
