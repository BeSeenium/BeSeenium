...
import beseenium.model.action.pageActions.PageGet;
 ...
 *
 */
public class MakePageGet extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakePageGet(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new PageGet(super.adFactory.makeActionData());
	}
}
