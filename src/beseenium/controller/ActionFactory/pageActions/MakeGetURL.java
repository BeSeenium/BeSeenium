...
import beseenium.model.action.pageActions.GetURL;
 ...
 *
 */
public class MakeGetURL extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeGetURL(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new GetURL(super.adFactory.makeActionData());
	}
}
