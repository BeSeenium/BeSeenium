...
import beseenium.model.action.pageActions.GetTitle;
 ...
 *
 */
public class MakeGetTitle extends MakeAction
{
	/**
	 * call to super constructor
	 * @param adf an ActionDataFactory
	 */
	public MakeGetTitle(ActionDataFactory adf)
	{super(adf);}
	...
	{
		return new GetTitle(super.adFactory.makeActionData());
	}
}
