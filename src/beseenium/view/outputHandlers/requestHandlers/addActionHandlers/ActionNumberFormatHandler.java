...
/**
 * This represents a handler for the case where the user has provided an index parameter for an 
 * action that is not a number, the user is then informed of this.
 * 
 * @author Jan P.C. Hanson
 *
 */
public class ActionNumberFormatHandler extends AbstractRequestHandler
{
