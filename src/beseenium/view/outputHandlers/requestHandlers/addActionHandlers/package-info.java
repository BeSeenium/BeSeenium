 ...
 * the 'addActions' url query string. The RootAddActions class is the start of the chain and
 ...
 * RootAddActions class should be modified to add this new class to the chain.
 * 
